...
export default function Charts({ dummyData, title, type }) {
    ...
    switch (tabName) {
      case "Day":
        ...
        const chartDataForHours = Object.values(orderDataByHour).sort(
          (a, b) => parseInt(a.hourInterval) - parseInt(b.hourInterval)
        );

        chartDataForHours.forEach((item) => {
      ...
      case "Week":
        ...
        const chartDataForWeek = Object.values(orderDataByWeekAndDay).sort(
          (a, b) => a.week - b.week || a.day.localeCompare(b.day)
        );

        // Generate the x and y axis data
        chartDataForWeek.forEach((item) => {
      ...
      case "Month":
        ...
        chartDataForWeeks.forEach((item) => {
